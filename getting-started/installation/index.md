...
Then run the [Quickstart](/getting-started/quickstart) to create your first workflow. If you use AI coding tools, install the bundled Dagu workflow authoring skill and connect the [Dagu MCP server](/mcp/) to operate a running Dagu server.
